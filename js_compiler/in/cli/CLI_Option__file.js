...
export class CLI_Option__file {
	...
	constructor(path) {
		System.die_if_not_type(path, 'path', DataType.string, 'string', 'CLI_Option__file.constructor');
	...
	static try_from_args(args) {
		System.die_if_not_array_of_type(args, 'args', DataType.string, 'string', 'CLI_Option__file.try_from_args');
